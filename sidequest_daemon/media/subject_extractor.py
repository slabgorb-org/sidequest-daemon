...
_PROMPT_TEMPLATE = (
    ...
    "  Lead with visual/compositional nouns, NOT proper nouns. Names mean nothing "
    "to the image model and crowd out what it can draw. Replace a named person with "
    "a descriptive noun (Padre Ferreira -> a robed priest; Noriko Nishida -> a "
    "young woman in a kimono) and a named place with its visual character (Hakone "
    "-> a misty mountain pass; Edo -> a lantern-lit teahouse street). Use at most "
    "one proper noun, and only if nothing visual can replace it.\n"
